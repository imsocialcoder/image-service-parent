...
public class AWSS3Service implements AWSS3ServiceInterface{
    ...
    @Autowired
    public AWSS3Service(ImageServiceAWSConfiguration imageServiceAWSConfiguration, ResourceLoader resourceLoader, ImageServicePredefinedTypesConfiguration imageServicePredefinedTypesConfiguration){
